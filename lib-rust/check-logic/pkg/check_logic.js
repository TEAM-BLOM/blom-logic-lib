...
* @returns {Board}
*/
export function init_board(_board) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray32ToWasm0(_board, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.init_board(retptr, ptr0, len0);
...
* @returns {Check}
*/
export function init_check(_board, x, y) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(_board, Board);
        var ptr0 = _board.__destroy_into_raw();
        wasm.init_check(retptr, ptr0, x, y);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
* @returns {boolean}
*/
export function check_win(check) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
const CheckFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_check_free(ptr >>> 0, 1));
/**
*/
export class Check {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        CheckFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CheckFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_check_free(ptr, 0);
    }
    /**
    * @param {Board} _board
    * @param {number} x
    * @param {number} y
    */
    constructor(_board, x, y) {
        _assertClass(_board, Board);
        var ptr0 = _board.__destroy_into_raw();
        const ret = wasm.check_new(ptr0, x, y);
        this.__wbg_ptr = ret >>> 0;
        CheckFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('check_logic_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
